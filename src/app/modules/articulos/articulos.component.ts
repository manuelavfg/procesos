...
export class ArticulosComponent implements AfterViewInit {
  displayedColumns: string[] = ['producto', 'unidad', 'cantidad', 'codigo', 'precio'];
...
const ELEMENT_DATA: Articles[] = [
  ...
  {producto: 'FLEJE DE HIERRO GALBANIZADO CON HEBILLA', unidad: 'PZA', cantidad: 10, codigo: '234BKR ', precio: 10},
